...
**Prepared 2026-08-24 · Site: liberationtimes.com (Squarespace) · Author: site reliability review, social-distribution lens**
...
Verify the domain at search.google.com/search-console (Squarespace: Settings → Domains gives you the DNS record). The **Google News performance report** inside Search Console is the definitive signal that inclusion has started. Watch it weekly.
